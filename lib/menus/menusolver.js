...
|----------------------------------------------------------------------------*/
'use strict';
var menuiteminterface_1 = require('./menuiteminterface');
...
function buildItem(item) {
    return new menuiteminterface_1.CommandMenuItem({
...
function buildSubmenu(items, text) {
    ...
    menuObj.items = items;
    return new menuiteminterface_1.CommandMenuItem({ text: text, submenu: menuObj });
}
/**
