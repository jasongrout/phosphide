...
class CommandRegistry {
   ...
   */
  static commandsAddedSignal = new Signal<CommandRegistry, ICommandItem[]>();
   ...
   * **See also:** [[commandsAdded]]
   */
  static commandsRemovedSignal = new Signal<CommandRegistry, ICommandItem[]>();
   ...
   */
  get commandsAdded(): ISignal<CommandRegistry, ICommandItem[]> {
   ...
   */
  get commandsRemoved(): ISignal<CommandRegistry, ICommandItem[]> {
